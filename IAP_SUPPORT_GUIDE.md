...
- 中国語（繁体）表示名: `開發支援包`
- 韓国語表示名: `개발 지원 팩`
- 日本語説明: `「まちあて！」を遊んでいただき、ありがとうございます。狼天紅ゲームズは、これからも麻雀ゲーム・人狼ゲームを中心に開発を続けていきます。「このゲームが面白かった」「今後の作品も楽しみ」と思っていただけた方は、開発支援をご検討ください。支援の特典として、Music Room（BGM全21曲を自由に聴ける機能）が解放されます。※支援をしなくても、ゲーム本編はすべて無料で遊べます。`
- 英語説明: `Thanks for playing Machi-ate! The Support Pack unlocks the Music Room with all 21 BGM tracks. The full game stays free without it. Your purchase helps us develop future mahjong and werewolf games.`
- 中国語（簡体）説明: `感谢您游玩《待牌猜猜看！》。购买开发支援包即可解锁 Music Room，随时欣赏游戏内全部21首 BGM。即使不购买，也可以免费游玩完整游戏。您的购买也将帮助狼天红 Games 继续开发更多麻将游戏和人狼游戏。`
- 中国語（繁体）説明: `感謝您遊玩《待牌猜猜看！》。購買開發支援包即可解鎖 Music Room，隨時欣賞遊戲內全部21首 BGM。即使不購買，也可以免費遊玩完整遊戲。您的購買也將幫助狼天紅 Games 繼續開發更多麻將遊戲和人狼遊戲。`
- 韓国語説明: `마치아테!를 플레이해 주셔서 감사합니다. 개발 지원 팩을 구매하면 게임 내 BGM 21곡을 언제든 들을 수 있는 Music Room이 해금됩니다. 구매하지 않아도 게임 본편은 모두 무료로 즐길 수 있습니다. 구매는 늑천홍 Games의 향후 마작 게임과 인랑 게임 개발에도 도움이 됩니다.`
- 日本価格: JPY 500
- 販売地域: Google Play対応の173か国 / 地域すべて（全行に価格設定済み・利用可能）
- Play Console status（2026-08-13確認）: `support_pack` / `standard`とも有効。5言語の商品説明を上記文面で保存済み。税区分はデジタルアプリの販売、年齢制限なし、支払い地域制限なし、商品アイコン追加なし
